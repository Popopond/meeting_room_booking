...
class CheckInsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check_in" do
    assert_difference("CheckIn.count") do
      post check_ins_url, params: { check_in: { booking_id: @check_in.booking_id, check_in: @check_in.check_in, created_at: @check_in.created_at, user_id: @check_in.user_id } }
    end
  ...
  test "should update check_in" do
    patch check_in_url(@check_in), params: { check_in: { booking_id: @check_in.booking_id, check_in: @check_in.check_in, created_at: @check_in.created_at, user_id: @check_in.user_id } }
